import { CheckCircle2, Circle, Pencil, Repeat2, Trash2 } from "lucide-react";
...
export function TaskList({ tasks }: { readonly tasks: readonly TaskRow[] }) {
