import { CalendarCheck, GitBranch, ListChecks, MessageSquareMore } from "lucide-react";

export function WeeklySummary({ eventsToday, todayTasks, waiting, workflows }: { readonly eventsToday: number; readonly todayTasks: number; readonly waiting: number; readonly workflows: number }) {
  const summaries = [
