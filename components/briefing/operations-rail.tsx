...
import { CalendarPlus, CheckSquare2, FilePenLine, TriangleAlert } from "lucide-react";
...
export function OperationsRail({ dueToday, eventsToday, priorityTasks, todayTasks, workflowItems }: { readonly dueToday: number; readonly eventsToday: EventRow[]; readonly priorityTasks: TaskRow[]; readonly todayTasks: TaskRow[]; readonly workflowItems: readonly WorkflowBriefingItem[] }) {
