...
export function OperationsRail({ eventsToday, quickNotes, school, today }: { readonly eventsToday: readonly EventRow[]; readonly quickNotes: readonly TaskRow[]; readonly school: UserSchoolSettings | null; readonly today: string }) {
