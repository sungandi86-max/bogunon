...
export function OperationsRail({ dueToday, eventsToday, priorityTasks, todayTasks }: { readonly dueToday: number; readonly eventsToday: EventRow[]; readonly priorityTasks: TaskRow[]; readonly todayTasks: TaskRow[] }) {
