    ...
    <>
      ...
      >
        <div className="mobile-create-menu">
          ...
          <button onClick={(event) => chooseAcademicImport(event.currentTarget)} type="button"><FileSpreadsheet aria-hidden="true" size={20} /><span><strong>학사일정 가져오기</strong><small>NEIS 또는 엑셀·CSV로 등록합니다.</small></span></button>
