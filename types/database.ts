...
export type PracticalToolScope = "public" | "personal";
export type PracticalToolIconKey = "online_health" | "spreadsheet" | "drive" | "school_system" | "website" | "other";
export type PracticalToolRow = { id: string; name: string; description: string | null; url: string; icon_key: PracticalToolIconKey; scope: PracticalToolScope; owner_id: string | null; is_active: boolean; created_at: string; updated_at: string };
...
export type Database = {
  public: {
    Tables: WorkflowDatabaseTables & {
      ...
      practical_tools: { Row: PracticalToolRow; Insert: Insert<PracticalToolRow, "id" | "created_at" | "updated_at">; Update: Partial<Omit<PracticalToolRow, "id" | "created_at" | "updated_at">>; Relationships: [] };
      practical_schedule_tools: { Row: PracticalScheduleToolRow; Insert: Insert<PracticalScheduleToolRow, "id" | "created_at">; Update: Partial<Omit<PracticalScheduleToolRow, "id" | "user_id" | "created_at">>; Relationships: [] };
