...
BOGUNON은 보건교사의 개인 업무 관리를 위한 웹 애플리케이션입니다. 일정 관리, 연간 계획, 학사일정 가져오기, 운동 기록, 급식, 날씨와 빠른 메모를 한곳에서 사용하며 Google OAuth와 사용자별 RLS로 개인 데이터를 보호합니다.
