...
export default async function AnnualPage({ searchParams }: { readonly searchParams: Promise<{ year?: string }> }) {
  ...
  return <main className="page-canvas annual-page"><PageHeader action={<AssistantTrigger label="연간 초안" surface="annual" />} description="마감, 반복 업무와 일정을 1월부터 12월까지 한눈에 확인합니다." title="연간 업무" />
