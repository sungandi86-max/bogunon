...
export default async function WorkflowsPage() {
  ...
  return <main className="page-canvas workflow-page"><PageHeader action={<div className="page-header__actions"><AssistantTrigger label="단계 추천" surface="workflow" /><MobileCreateButton /></div>} description="보건업무 절차의 현재 단계와 다음 행동을 관리합니다." title="업무 절차" /><WorkflowWorkspace data={data} tasks={tasks} /></main>;
}
