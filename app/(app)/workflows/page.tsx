...
export default async function WorkflowsPage() {
  ...
  return <main className="page-canvas workflow-page"><PageHeader action={<MobileCreateButton />} description="보건업무 절차의 현재 단계와 다음 행동을 관리합니다." title="Workflow" /><WorkflowWorkspace data={data} tasks={tasks} /></main>;
}
